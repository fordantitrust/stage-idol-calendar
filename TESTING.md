...
**Test Case 3.6.7**: Rate limit window reset
...
**Test Case 3.6.7**: Different IPs independent limits
...
**Test Case 3.6.7**: Max length - Title
...
**Test Case 3.6.7**: Max length - Description
...
**Test Case 3.6.7**: Array size limit
