...
**Test Case 3.6.10**: Rate limit window reset
...
**Test Case 3.6.10**: Different IPs independent limits
...
**Test Case 3.6.10**: Max length - Title
...
**Test Case 3.6.10**: Max length - Description
...
**Test Case 3.6.10**: Array size limit
...
**Test Case 6.4.1**: Load programs list
...
**Test Case 6.4.1**: Filter by venue
...
**Test Case 6.4.1**: Delete single program
...
**Test Case 6.4.1**: Bulk delete programs
...
**Test Case 6.4.1**: Bulk edit venue
...
**Test Case 6.4.1**: Bulk edit organizer
...
**Test Case 6.4.1**: Add event request
...
**Test Case 6.4.1**: Modify event request
...
**Test Case 6.4.1**: Validation - Required fields
...
**Test Case 16.7.1**: Service Worker registers and activates on a fresh load
...
**Test Case 16.7.1**: Private APIs bypass cache when offline
