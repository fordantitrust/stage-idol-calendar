...
File and folder structure for Idol Stage Timetable v16.5.3
...
| `ratelimit/fav_rl_*.json` | Favorites per-IP rate-limit counters (`FAVORITES_RL_DIR`, v16.5.3) | rolling window |
...
| `generate-favorites-secret.php` | Generate the Favorites HMAC secret → writes `config/favorites-config.json` (overwrite-guarded) (v16.5.3) | - |
