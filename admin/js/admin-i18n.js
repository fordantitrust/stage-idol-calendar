...
(function () {
    ...
    const dict = {
        th: {
            ...
            'settings.telegramNotifyMinutes': 'แจ้งเตือนก่อน (นาที)',
            'settings.telegramNotifyMinutesHint': 'นาทีก่อนโปรแกรมจะส่งการแจ้งเตือน (5-1440)',
        ...
        en: {
            ...
            'settings.telegramNotifyMinutes': 'Notify Before (minutes)',
            'settings.telegramNotifyMinutesHint': 'Minutes before program to send notification (5-1440)',
