        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <ul>
                    ...
                    <li data-i18n="section7.feature2">คลิกที่แถบ event เพื่อดูรายละเอียด</li>
                    <li data-i18n="section7.feature3">ระบบจะจำมุมมองที่คุณเลือกไว้</li>
                </ul>
            </div>

            <div class="section">
                <h2 data-i18n="section8.title">📝 แจ้งเพิ่ม/แก้ไข Event</h2>
                <p data-i18n="section8.desc">หากพบว่าข้อมูลไม่ครบ หรือมี event ใหม่ที่ยังไม่มีในระบบ คุณสามารถแจ้งได้:</p>

                <h3 data-i18n="section8.add.title">1. แจ้งเพิ่ม Event ใหม่</h3>
                <p data-i18n="section8.add.desc">กดปุ่ม "📝 แจ้งเพิ่ม Event" แล้วกรอกข้อมูล event ที่ต้องการ</p>

                <h3 data-i18n="section8.modify.title">2. แจ้งแก้ไข Event ที่มีอยู่</h3>
                <p data-i18n="section8.modify.desc">กดปุ่ม "✏️" ที่ event ที่ต้องการแก้ไข ระบบจะ pre-fill ข้อมูลให้</p>
